                  ...
                  <tr key={t.id} className="hover:bg-slate-50/50 transition-colors">
                    ...
                    <td className="p-3 text-center">
                      <button
                        ...
                        className="px-3 py-1.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg font-bold transition-transform transform active:scale-95 text-[11px]"
                      >
                        ตรวจสอบและอนุมัติ
                      </button>
                    </td>
              ...
              {allTxns?.map((t: any) => (
                <tr key={t.id} className="hover:bg-slate-50/50 transition-colors">
                  ...
                  <td className="p-3 text-center">
                    <button
                      onClick={() => handleViewTxnDetails(t.docNo)}
                      className="px-2.5 py-1.5 border border-slate-200 hover:bg-slate-50 text-slate-600 rounded-lg font-semibold transition-transform transform active:scale-95 text-[11px]"
                    >
                      ดูรายละเอียด
                    </button>
                  </td>
